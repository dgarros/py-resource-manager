...
class Test_Validate_Init(unittest.TestCase):
    def test_init_v4(self):
        ...
        self.assertEqual(sub.available_subnets[29], ['192.168.0.0/29', '192.168.0.8/29'])
...
class Test_Validate_split_supernet(unittest.TestCase):
    def test_split_first(self):
        ...
        self.assertEqual(sub.available_subnets[27], ['192.168.0.128/27', '192.168.0.160/27'])
    ...
    def test_split_middle(self):
        ...
        self.assertEqual(sub.available_subnets[27], ['192.168.0.192/27', '192.168.0.224/27'])
    ...
    def test_split_end(self):
        ...
        self.assertEqual(sub.available_subnets[27], ['192.168.255.192/27', '192.168.255.224/27'])
...
class Test_Validate_Get_Subnet(unittest.TestCase):
    ...
    def test_v4_with_owner(self):
        ...
        self.assertEqual(str(sub.get_subnet(size=24, identifier='first')), "192.168.0.0/24")
        self.assertEqual(str(sub.get_subnet(size=25, identifier='second')), "192.168.1.0/25")
        self.assertEqual(str(sub.get_subnet(size=17, identifier='third')), "192.168.128.0/17")
        self.assertEqual(str(sub.get_subnet(size=25, identifier='second')), "192.168.1.0/25")
        self.assertEqual(str(sub.get_subnet(size=17, identifier='third')), "192.168.128.0/17")
...
class Test_Validate_Check_if_Already_Reserved(unittest.TestCase):
    def test_v4_no_owner(self):
        ...
        self.assertEqual(str(sub.get_subnet(size=24, identifier="first")), "192.168.0.0/24")
        self.assertEqual(str(sub.get_subnet(size=24, identifier="second")), "192.168.1.0/24")
